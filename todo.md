...
- [x] 4.1: حذف/کاهش `any` در فرانت‌اند (~۹۰ مورد) — تایپ‌گزارس کامل `adminApi` و `RecentActivity` — صفر `any` در تمام فایل‌ها ✅
- [x] 4.2: اصلاح naming مخفف در `admin/page.tsx` — تمام متغیرهای مخفف به نام‌های توصیفی تغییر یافتند ✅
